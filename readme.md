...
### 🌦️ Weatherstack HUD
Weather is handled through Weatherstack. A user-requested weather check opens a temporary animated HUD screen; the HUD closes with the CLOSE button or a voice command such as “close weather”. Background refresh stays silent.
...
| 🌤️ Weather Report | Weatherstack live weather opens a temporary animated HUD screen, with detailed current/forecast reports when supported |
